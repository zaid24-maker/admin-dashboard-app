    ...
    return (
        <div className="space-y-6 pb-12">
            <div className="flex justify-between items-center bg-slate-900/50 p-6 rounded-2xl border border-slate-800">
                ...
                <div className="flex items-center space-x-3 bg-slate-950 px-4 py-2 rounded-xl border border-slate-800 shadow-inner">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="bg-slate-900 p-6 rounded-2xl border border-slate-700/50 shadow-xl relative overflow-hidden">
                    ...
                    <div className="flex flex-col relative z-10">
                        ...
                        <div className="w-full bg-slate-950 h-2 mt-4 rounded-full overflow-hidden shadow-inner border border-slate-800">
                ...
                <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.1 }} className="bg-slate-900 p-6 rounded-2xl border border-slate-700/50 shadow-xl relative overflow-hidden">
                ...
                <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.2 }} className="bg-slate-900 p-6 rounded-2xl border border-slate-700/50 shadow-xl relative overflow-hidden">
                ...
                <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.3 }} className="bg-slate-900 p-6 rounded-2xl border border-slate-700/50 shadow-xl relative overflow-hidden">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="col-span-12 lg:col-span-4 space-y-6">
                    <div className="bg-slate-900/50 border-l-4 border-rose-500 p-5 rounded-xl shadow-lg">
                ...
                <div className="col-span-12 lg:col-span-8">
                    ...
                    <div className="bg-slate-900 border border-slate-700/50 rounded-2xl shadow-xl overflow-hidden p-6 h-56 flex items-end space-x-2 relative">
                        {history.map((h, idx) => (
                            <div key={idx} className="flex-1 bg-slate-950 rounded-t-lg relative overflow-hidden transition-all hover:bg-slate-800" style={{ height: '100%' }}>
