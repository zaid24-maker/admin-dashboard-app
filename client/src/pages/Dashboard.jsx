...
import { Activity, CheckCircle, Clock, AlertTriangle, Play, Pause, Trash2, Loader2, TrendingUp, BarChart3 } from 'lucide-react';
        ...
        const fetchDashboardData = async () => {
            try {
                ...
                const [statRes, flowRes] = await Promise.all([
                    fetch('http://localhost:5001/api/workflows/stats', { headers: { 'Authorization': `Bearer ${token}` } }),
    ...
    return (
        <div className="space-y-8 pb-12">
            ...
            <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-8 rounded-3xl border border-slate-700/50 shadow-2xl relative overflow-hidden">
                ...
                <div className="absolute -bottom-16 -left-16 w-48 h-48 bg-purple-600/10 blur-[80px] rounded-full pointer-events-none"></div>
            ...
            <motion.div
                ...
                className="bg-slate-800/80 backdrop-blur-sm border border-slate-700/50 p-8 rounded-2xl shadow-xl relative overflow-hidden"
            >
